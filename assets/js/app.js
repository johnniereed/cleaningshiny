...
document.querySelector('.cleaning-nav--prev')?.addEventListener('click',()=>showCleaningSlide(cleaningIndex-1));
document.querySelector('.cleaning-nav--next')?.addEventListener('click',()=>showCleaningSlide(cleaningIndex+1));
showCleaningSlide(0);
